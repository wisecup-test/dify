...
- **R-EX-001** MAY: Internal APIs MAY implement circuit breaker or retry patterns at the external client boundary for resilience.
...
# Verify all storage, telemetry, and plugin extension modules define abstract interfaces
