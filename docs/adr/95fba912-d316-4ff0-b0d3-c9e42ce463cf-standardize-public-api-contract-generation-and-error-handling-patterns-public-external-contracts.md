...
1. MUST: All public/external API contracts MUST be generated from a single source of truth using code generation tools (e.g., OpenAPI, TypeScript generators)

## Policy Block

- MUST All public/external API contracts MUST be generated from a single source of truth using code generation tools (e.g., OpenAPI, TypeScript generators)
