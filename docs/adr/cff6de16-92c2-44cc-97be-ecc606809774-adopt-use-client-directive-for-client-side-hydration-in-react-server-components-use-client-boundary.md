...
1. SHOULD: The 'use client' boundary SHOULD be placed as deep in the component tree as possible to minimize client-side JavaScript bundle size

## Policy Block

- SHOULD The 'use client' boundary SHOULD be placed as deep in the component tree as possible to minimize client-side JavaScript bundle size
