...
1. SHOULD: Frontend component libraries SHOULD separate presentational logic from state management, using patterns like atoms.ts for state primitives and utils.ts for pure functions

## Policy Block

- SHOULD Frontend component libraries SHOULD separate presentational logic from state management, using patterns like atoms.ts for state primitives and utils.ts for pure functions
