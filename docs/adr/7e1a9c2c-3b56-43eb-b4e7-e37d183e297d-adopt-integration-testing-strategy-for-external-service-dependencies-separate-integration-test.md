...
1. SHOULD: A separate integration test suite SHOULD run against real external services in staging or pre-production environments to validate actual service behavior

## Policy Block

- SHOULD A separate integration test suite SHOULD run against real external services in staging or pre-production environments to validate actual service behavior
