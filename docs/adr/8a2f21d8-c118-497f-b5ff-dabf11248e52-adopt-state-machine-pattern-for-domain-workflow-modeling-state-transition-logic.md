...
1. MUST_NOT: State transition logic MUST NOT be scattered across multiple layers; it MUST be centralized in domain model or service layer

## Policy Block

- MUST_NOT State transition logic MUST NOT be scattered across multiple layers; it MUST be centralized in domain model or service layer
