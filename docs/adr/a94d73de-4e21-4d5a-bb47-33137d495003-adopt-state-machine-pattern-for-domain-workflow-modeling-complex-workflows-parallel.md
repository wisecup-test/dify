...
1. SHOULD: Complex workflows with parallel execution or human intervention SHOULD model state explicitly with join/resume semantics

## Policy Block

- SHOULD Complex workflows with parallel execution or human intervention SHOULD model state explicitly with join/resume semantics
