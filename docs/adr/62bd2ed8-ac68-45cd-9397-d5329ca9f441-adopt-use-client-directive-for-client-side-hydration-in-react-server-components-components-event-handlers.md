...
1. MUST: Components with event handlers (onClick, onChange, onSubmit, etc.) MUST be marked with 'use client'

## Policy Block

- MUST Components with event handlers (onClick, onChange, onSubmit, etc.) MUST be marked with 'use client'
