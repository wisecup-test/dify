...
1. MUST: Python integration tests MUST be organized under api/tests/test_containers_integration_tests/ or similar integration-specific directories

## Policy Block

- MUST Python integration tests MUST be organized under api/tests/test_containers_integration_tests/ or similar integration-specific directories
