...
1. SHOULD: Server components SHOULD NOT include the 'use client' directive to maximize server-side rendering benefits

## Policy Block

- SHOULD Server components SHOULD NOT include the 'use client' directive to maximize server-side rendering benefits
