...
1. MUST: Components using React hooks (useState, useEffect, useContext, etc.) MUST be marked with 'use client'

## Policy Block

- MUST Components using React hooks (useState, useEffect, useContext, etc.) MUST be marked with 'use client'
