...
1. MUST: State transitions MUST be validated against a defined set of allowed transitions before persistence

## Policy Block

- MUST State transitions MUST be validated against a defined set of allowed transitions before persistence
