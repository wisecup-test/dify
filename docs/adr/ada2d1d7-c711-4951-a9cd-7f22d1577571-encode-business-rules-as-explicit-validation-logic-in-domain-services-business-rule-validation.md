...
1. MUST: Business rule validation MUST occur in the service layer, not in controllers or storage adapters

## Policy Block

- MUST Business rule validation MUST occur in the service layer, not in controllers or storage adapters
