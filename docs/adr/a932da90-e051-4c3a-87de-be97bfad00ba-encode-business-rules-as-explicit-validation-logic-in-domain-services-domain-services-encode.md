...
1. MUST: Domain services MUST encode business rules as explicit validation logic before performing domain operations

## Policy Block

- MUST Domain services MUST encode business rules as explicit validation logic before performing domain operations
