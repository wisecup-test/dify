...
1. MUST: Validation schemas MUST be defined using type-safe validation libraries: Zod for TypeScript/JavaScript, Pydantic or similar for Python

## Policy Block

- MUST Validation schemas MUST be defined using type-safe validation libraries: Zod for TypeScript/JavaScript, Pydantic or similar for Python
