...
1. SHOULD: API contract generation SHOULD be integrated into the build pipeline to ensure contracts are always up-to-date

## Policy Block

- SHOULD API contract generation SHOULD be integrated into the build pipeline to ensure contracts are always up-to-date
