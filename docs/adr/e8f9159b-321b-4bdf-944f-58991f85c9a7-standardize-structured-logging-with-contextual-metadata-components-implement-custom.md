...
1. MAY: Components MAY implement custom log formatters or handlers to meet specific operational requirements while maintaining structured format compatibility

## Policy Block

- MAY Components MAY implement custom log formatters or handlers to meet specific operational requirements while maintaining structured format compatibility
