...
1. MUST: Validation failures MUST raise domain-specific exceptions with clear error messages indicating which business rule was violated

## Policy Block

- MUST Validation failures MUST raise domain-specific exceptions with clear error messages indicating which business rule was violated
