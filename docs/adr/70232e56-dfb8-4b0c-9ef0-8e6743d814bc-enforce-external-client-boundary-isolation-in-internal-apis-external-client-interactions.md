...
1. MUST: All external client interactions MUST be mockable or stubbable for unit testing purposes

## Policy Block

- MUST All external client interactions MUST be mockable or stubbable for unit testing purposes
