...
1. MUST: Services MUST implement idempotent message handlers to safely handle duplicate message delivery

## Policy Block

- MUST Services MUST implement idempotent message handlers to safely handle duplicate message delivery
