...
1. MUST: Generated API contracts and validation schemas MUST be kept in sync with their source definitions and regenerated as part of the build process

## Policy Block

- MUST Generated API contracts and validation schemas MUST be kept in sync with their source definitions and regenerated as part of the build process
