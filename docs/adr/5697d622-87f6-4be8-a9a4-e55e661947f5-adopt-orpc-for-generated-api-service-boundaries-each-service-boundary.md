...
1. MUST: Each service boundary MUST generate an orpc.gen.ts file containing the complete type-safe contract definition

## Policy Block

- MUST Each service boundary MUST generate an orpc.gen.ts file containing the complete type-safe contract definition
