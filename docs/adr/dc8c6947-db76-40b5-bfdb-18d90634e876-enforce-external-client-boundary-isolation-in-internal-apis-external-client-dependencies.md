...
1. MUST: External client dependencies MUST be injected through dependency injection or factory patterns rather than instantiated directly within internal API logic

## Policy Block

- MUST External client dependencies MUST be injected through dependency injection or factory patterns rather than instantiated directly within internal API logic
