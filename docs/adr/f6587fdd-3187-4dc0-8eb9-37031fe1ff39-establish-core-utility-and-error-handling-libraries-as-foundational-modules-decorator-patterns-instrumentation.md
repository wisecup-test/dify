...
1. MUST: Decorator patterns for instrumentation and cross-cutting concerns MUST be implemented as library modules in dedicated directories (e.g., extensions/otel/decorators/)

## Policy Block

- MUST Decorator patterns for instrumentation and cross-cutting concerns MUST be implemented as library modules in dedicated directories (e.g., extensions/otel/decorators/)
