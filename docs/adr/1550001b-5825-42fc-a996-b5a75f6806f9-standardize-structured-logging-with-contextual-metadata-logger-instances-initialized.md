...
1. SHOULD: Logger instances SHOULD be initialized at module level with appropriate namespace identifiers to facilitate log filtering and routing

## Policy Block

- SHOULD Logger instances SHOULD be initialized at module level with appropriate namespace identifiers to facilitate log filtering and routing
