...
1. MUST: Environment variable names MUST follow a consistent naming convention (uppercase with underscores) and include component prefixes where appropriate

## Policy Block

- MUST Environment variable names MUST follow a consistent naming convention (uppercase with underscores) and include component prefixes where appropriate
