...
1. MUST: Third-party scripts MUST be loaded asynchronously using dynamic script element injection to prevent render blocking

## Policy Block

- MUST Third-party scripts MUST be loaded asynchronously using dynamic script element injection to prevent render blocking
