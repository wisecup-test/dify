...
1. SHOULD: Frontend component tests SHOULD be co-located with their components in __tests__ subdirectories to maintain proximity and discoverability

## Policy Block

- SHOULD Frontend component tests SHOULD be co-located with their components in __tests__ subdirectories to maintain proximity and discoverability
