...
1. MUST: Components accessing browser APIs (window, document, localStorage, etc.) MUST be marked with 'use client'

## Policy Block

- MUST Components accessing browser APIs (window, document, localStorage, etc.) MUST be marked with 'use client'
