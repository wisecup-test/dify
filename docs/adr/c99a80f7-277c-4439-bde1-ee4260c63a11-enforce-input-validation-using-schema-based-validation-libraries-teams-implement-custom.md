...
1. MAY: Teams MAY implement custom validation rules beyond standard type checking when domain-specific constraints are required

## Policy Block

- MAY Teams MAY implement custom validation rules beyond standard type checking when domain-specific constraints are required
