...
1. MUST: Services MUST use message queues as the primary integration mechanism for asynchronous operations that cross service boundaries

## Policy Block

- MUST Services MUST use message queues as the primary integration mechanism for asynchronous operations that cross service boundaries
