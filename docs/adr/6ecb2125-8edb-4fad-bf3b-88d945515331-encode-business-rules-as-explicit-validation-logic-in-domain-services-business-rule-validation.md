...
1. MUST_NOT: Business rule validation logic MUST NOT be duplicated across multiple service methods or classes

## Policy Block

- MUST_NOT Business rule validation logic MUST NOT be duplicated across multiple service methods or classes
