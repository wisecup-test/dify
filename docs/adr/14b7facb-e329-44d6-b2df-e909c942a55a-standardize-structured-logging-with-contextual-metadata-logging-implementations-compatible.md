...
1. MUST: Logging implementations MUST be compatible with OpenTelemetry trace context propagation to enable correlation between logs and traces

## Policy Block

- MUST Logging implementations MUST be compatible with OpenTelemetry trace context propagation to enable correlation between logs and traces
