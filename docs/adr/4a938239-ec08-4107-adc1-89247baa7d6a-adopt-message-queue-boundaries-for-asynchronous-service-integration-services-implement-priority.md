...
1. MAY: Services MAY implement priority queues when different message types require different processing urgency

## Policy Block

- MAY Services MAY implement priority queues when different message types require different processing urgency
