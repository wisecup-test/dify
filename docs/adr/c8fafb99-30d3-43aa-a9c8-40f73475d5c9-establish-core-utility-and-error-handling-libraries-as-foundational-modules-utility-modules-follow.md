...
1. SHOULD: Utility modules SHOULD follow naming conventions that clearly indicate their purpose: utils.ts/utils.py for general utilities, base.py for base classes, atoms.ts for state management primitives

## Policy Block

- SHOULD Utility modules SHOULD follow naming conventions that clearly indicate their purpose: utils.ts/utils.py for general utilities, base.py for base classes, atoms.ts for state management primitives
