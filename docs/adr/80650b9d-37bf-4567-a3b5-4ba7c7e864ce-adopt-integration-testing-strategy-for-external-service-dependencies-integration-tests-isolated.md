...
1. MUST: Integration tests MUST be isolated from unit tests and clearly marked to enable selective execution in CI/CD pipelines

## Policy Block

- MUST Integration tests MUST be isolated from unit tests and clearly marked to enable selective execution in CI/CD pipelines
