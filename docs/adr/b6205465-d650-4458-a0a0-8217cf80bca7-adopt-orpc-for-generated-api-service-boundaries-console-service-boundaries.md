...
1. MUST: All console API service boundaries MUST be defined using oRPC framework with generated TypeScript contracts

## Policy Block

- MUST All console API service boundaries MUST be defined using oRPC framework with generated TypeScript contracts
