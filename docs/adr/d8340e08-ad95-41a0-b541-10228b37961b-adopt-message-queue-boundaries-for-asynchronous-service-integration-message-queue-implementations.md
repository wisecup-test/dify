...
1. MUST: Message queue implementations MUST provide at-least-once delivery guarantees to ensure message reliability

## Policy Block

- MUST Message queue implementations MUST provide at-least-once delivery guarantees to ensure message reliability
