...
1. SHOULD: Message schemas SHOULD be versioned to support backward-compatible evolution of service contracts

## Policy Block

- SHOULD Message schemas SHOULD be versioned to support backward-compatible evolution of service contracts
