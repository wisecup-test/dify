...
1. SHOULD: State machines SHOULD separate state representation from transition logic using dedicated state handler or strategy classes

## Policy Block

- SHOULD State machines SHOULD separate state representation from transition logic using dedicated state handler or strategy classes
