...
1. MUST: Domain entities with lifecycle states MUST explicitly define all valid states as enumerated types or constants

## Policy Block

- MUST Domain entities with lifecycle states MUST explicitly define all valid states as enumerated types or constants
