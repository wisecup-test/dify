...
1. SHOULD: Message queue configuration parameters SHOULD be externalized to support different deployment environments

## Policy Block

- SHOULD Message queue configuration parameters SHOULD be externalized to support different deployment environments
