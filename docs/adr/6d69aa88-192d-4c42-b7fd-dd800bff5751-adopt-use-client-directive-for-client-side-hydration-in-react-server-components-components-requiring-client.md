...
1. MUST: Components requiring client-side JavaScript execution MUST include the 'use client' directive as the first line of the file

## Policy Block

- MUST Components requiring client-side JavaScript execution MUST include the 'use client' directive as the first line of the file
