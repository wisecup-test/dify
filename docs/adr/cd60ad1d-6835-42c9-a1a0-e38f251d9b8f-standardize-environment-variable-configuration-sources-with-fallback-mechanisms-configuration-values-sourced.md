...
1. MUST: All configuration values MUST be sourced from environment variables using os.environ.get() or equivalent methods that support default values

## Policy Block

- MUST All configuration values MUST be sourced from environment variables using os.environ.get() or equivalent methods that support default values
