...
1. MUST: Each state transition MUST be atomic and maintain domain invariants throughout the transition

## Policy Block

- MUST Each state transition MUST be atomic and maintain domain invariants throughout the transition
