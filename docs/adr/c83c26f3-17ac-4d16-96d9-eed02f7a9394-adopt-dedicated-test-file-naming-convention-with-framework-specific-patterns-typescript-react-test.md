...
1. MUST: TypeScript/React test files MUST use the *.spec.tsx or *.spec.ts naming convention and be placed in __tests__ directories adjacent to the code under test

## Policy Block

- MUST TypeScript/React test files MUST use the *.spec.tsx or *.spec.ts naming convention and be placed in __tests__ directories adjacent to the code under test
