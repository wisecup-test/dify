...
1. MUST: Third-party SDK initialization functions MUST be attached to the window object with proper TypeScript interface declarations

## Policy Block

- MUST Third-party SDK initialization functions MUST be attached to the window object with proper TypeScript interface declarations
