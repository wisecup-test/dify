...
1. MUST: All components that integrate with external services (AWS S3, OpenTelemetry, browser APIs) MUST include integration tests that validate the interaction contract

## Policy Block

- MUST All components that integrate with external services (AWS S3, OpenTelemetry, browser APIs) MUST include integration tests that validate the interaction contract
