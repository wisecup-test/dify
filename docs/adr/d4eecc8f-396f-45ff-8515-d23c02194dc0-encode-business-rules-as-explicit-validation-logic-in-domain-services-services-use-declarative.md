...
1. MAY: Services MAY use declarative validation frameworks or decorators to express business rules when appropriate for readability

## Policy Block

- MAY Services MAY use declarative validation frameworks or decorators to express business rules when appropriate for readability
