...
1. MAY: Teams MAY create domain-specific utility modules (e.g., workflow/utils, plugins/utils) when functionality is specific to that domain but reused within it

## Policy Block

- MAY Teams MAY create domain-specific utility modules (e.g., workflow/utils, plugins/utils) when functionality is specific to that domain but reused within it
