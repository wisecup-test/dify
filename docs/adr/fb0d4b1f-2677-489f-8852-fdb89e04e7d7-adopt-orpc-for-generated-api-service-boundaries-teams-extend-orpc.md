...
1. MAY: Teams MAY extend the oRPC framework with custom middleware or plugins for cross-cutting concerns like authentication or logging

## Policy Block

- MAY Teams MAY extend the oRPC framework with custom middleware or plugins for cross-cutting concerns like authentication or logging
