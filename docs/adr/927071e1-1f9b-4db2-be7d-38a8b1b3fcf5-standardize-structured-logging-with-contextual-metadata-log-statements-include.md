...
1. MUST: Log statements MUST include relevant contextual information such as request IDs, user identifiers, operation types, and resource identifiers where applicable

## Policy Block

- MUST Log statements MUST include relevant contextual information such as request IDs, user identifiers, operation types, and resource identifiers where applicable
